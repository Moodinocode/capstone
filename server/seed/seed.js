...
const projectsData = [
  ...
  { projectNumber: 'P-108', title: 'Etoile',                     teamName: 'Mayass Ayoub',     category: 'Business Plan', description: '', members: [{ name: 'Mayass Ayoub', role: 'Presenter' }, { name: 'Mohammad El Mais', role: 'Team Member' }, { name: 'Dany Kaboul', role: 'Team Member' }], tags: ['featured'], imageUrl: '/projects/etoile.png', documentUrl: '/projects/etoile.pdf' },
